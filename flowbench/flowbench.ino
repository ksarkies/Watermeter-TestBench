...
Connect three pin plug (black = gnd, red = 5V, white = signal) to header A0 of the Arduino Sensor Shield
*/
...
void loop(){
// Protect and capture current count value and reset it.
  cli();
